...
function Login() {
  ...
  return (
    <div className='flex flex-col items-center justify-center min-h-screen px-6 py-10 bg-white relative'>
      ...
      className='text-4xl font-extrabold text-green-700 mb-2'> Welcome Back
      ...
      <p
        ...
        className=' text-gray-600 mb-8 flex items-center'> Login To Snapcart. <Leaf className='w-5 h-5 text-green-600' />
      </p>
      <motion.form
      ...
      <p className= ' cursor-pointer text-gray-600 mt-6 text-sm flex items-center gap-1' onClick={()=>router.push("/register")}>Want to create  an account ?<LogIn className=' w-4 h-4' /> <span className='text-green-700'>Sign Up</span>
      </p>
