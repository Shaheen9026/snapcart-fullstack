...
flex flex-col p-6 text-white"
          >
            <div className="flex justify-between items-center mb-2">
              ...
              <button
                className="text-white/80 hover:text-red-500 text-2xl font-bold transition"
            ...
            <div className="flex flex-col gap-3 font-medium mt-6">
              <Link
                ...
                className="flex items-center gap-3 rounded-lg bg-white/10 hover:bg-white/20 hover:pl-4 transition-all"
              >
            ...
            <div
              className="flex items-center gap-3 text-red-300 font-semibold mt-auto hover:bg-red-600/20 p-3 rounded-lg transition-all"
          ...
          <AnimatePresence>
            {open && (
              ...
              >
                ...
                <button
                  className="flex items-center gap-2 w-full text-left px-3 hover:bg-red-50 rounded-lg text-gray-700 font-medium"
                  onClick={() => {
                    setOpen(false);
