    ...
    bg-linear-to-b from-green-100 to-white'>
      ...
      < motion.p
       ...
       className='mt-4 text-gray-700 text-lg md:text-xl max-w-lg'>
        ...
        Your one-stop destination for farm-fresh groceries, organic produce, and everyday essentials delivered fresh to your doorstep.
      </motion.p>
      ...
      >      <ShoppingBasket className='w-26 h-26 md:w-34 md:h-34 text-green-600  drop-shadow-md' />
      <Bike     className='w-26 h-26 md:w-34 md:h-34 text-orange-600  drop-shadow-md'/>
      </motion.div>
